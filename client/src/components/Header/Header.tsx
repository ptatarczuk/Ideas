...
const pages = ["Threads", "Users", "Login"];  // Login tymczasowo tutaj, potem przeniesc do guzika po prawej ! (lub zamiast niego)
    ...
    const userContext = useContext(UserContext);
         ...
         const handleLogout = async () => {
           try {
             ...
             console.log(
               "An error occurred while logging out on the server:",
               error
             );
           }
